...
import { templateInputs } from '../../../utils/form_inputs/inputs-create-template';
  ...
  const handleSubmit = async provider => {
    try {
      ...
      if (isSuccess(response)) {
        const successMessage = `Template ${isEdition ? 'actualizado' : 'creado'}.`;
          ...
          <div className="formStyle">
            ...
            <div>
              <AntForm
                ...
                submitText={id ? 'Editar Template' : 'Crear Template'}
